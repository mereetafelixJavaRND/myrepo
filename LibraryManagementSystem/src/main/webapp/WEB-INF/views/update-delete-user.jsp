   ...
   <div class="container" align="center">
    <div class="row">
     <table class="table table-striped table-condensed">
      ...
      <c:forEach var="user" items="${users}" varStatus="c">
	    ...
	    <tbody>
	     <tr>
	      ...
	      <td>
	       ...
	       <a href="${deleteLink}" class="btn btn-danger btn-xs"  onclick="if (!(confirm('Are you sure you want to delete this User?'))) return false"><span
